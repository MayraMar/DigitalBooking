...
--
-- Servidor: localhost
-- Tiempo de generación: 04-11-2022 a las 10:49:29
...
(1, '153.242 apartamentos disponibles', 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'Apartamentos'),
(2, '36.670 casas disponibles', 'https://images.pexels.com/photos/1370704/pexels-photo-1370704.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'Casas'),
(3, '108.555 lofts disponibles', 'https://images.pexels.com/photos/6077368/pexels-photo-6077368.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'Lofts'),
(4, '78.900 cabañas disponibles', 'https://images.pexels.com/photos/128303/pexels-photo-128303.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'Cabañas');
...
INSERT INTO `product` (`id`, `title`, `address`, `description`, `number_of_bathrooms`, `room_number`, `name`, `category_id`, `city_id`) VALUES
(1, 'Duplex de diseño en lo mejor de Recoleta', 'ABG', 'Fantástico dúplex de un dormitorio con sala de estar enorme y una linda terraza en el dormitorio. Perfecta Ubicación en lo mejor de Recoleta\r\nOtros aspectos a destacar\r\nEn general aceptamos mascotas\r\nGracias', 1, 1, 'Duplex Recoleta', 1, 1),
(2, 'Acogedor apartamento con gran vista, gimnasio y azotea', 'Barrios unidos', 'Zonas Comunes:\r\n- Gimnasio, Salón de Yoga, TRX, Rooftop, Lounge,  Billar Pool, Ping Pong. \r\n-  Piscina, Jacuzzy y Sauna\r\nPodrás usar las zonas comunes del edificio con reservación previa sujeta a disponibilidad y aforo por protocolos de bioseguridad', 1, 2, 'Apart Unidos', 1, 3),
(3, 'Casa de vacaciones en las Sierras de Córdoba!','villa allende', 'Hermosa Casa de Veraneo en el balneario mas importante de Villa Carlos Paz! Está a unas pocas cuadras del río San Antonio, el bado de tala huasi o el río de Icho Cruz. A 10\" de Carlos Paz, y a pocas cuadras de la calle principal del pueblo.', 2, 3, 'Casa Allende', 2, 2),
(4, 'Hermosa casa céntrica, espaciosa y dotada para 6', 'casa medellin', 'Esta espectacular vivienda te brinda una experiencia local y esta cerca de hermosos lugares naturales que visitar con cercanía a deliciosos restaurantes. Es muy cómoda, cuenta con todo lo necesario de primera mano para que sientas que llegaste a tu hogar.', 2, 3, 'Casa Medallo', 2, 4),
(5, 'Depto Studio en el centro con vista al lago', 'San Carlos de Bariloche', 'Disfrutá de una experiencia con estilo en este alojamiento céntrico.', 1, 2, 'Dpto BAM', 3, 5),
(6, 'Casa de lujo frente a la playa', 'Cartagena de indias', 'Disfrute de las mejores vacaciones de lujo en esta impresionante casa frente a la playa, ubicada en el exclusivo barrio de Cartagena. Cada detalle ha sido diseñado profesionalmente para una vida familiar activa y el máximo confort desde hace 53 años', 2, 3, 'Casa Porto', 3, 6),
(7, 'Cabaña en Villa General Belgrano', 'Villa General Belgrano', 'Villa natural, Ambiente Natural , cabaña de tronco , muy cómoda, zona residencial,  cerca del centro.', 2, 3, 'Villa Natural', 4, 2),
(8, 'La naturaleza es tu casa', 'Antioquia', 'Tu casa en la naturaleza.   En la bella región de Santa Elena,  lindando con la reserva forestal del Parque Arví,  a solo 40 minutos de Medellín,  pero con la tranquilidad del campo.', 2, 3, 'Casa Antioquia', 2, 4);
